      ...
      <Fade>
        <div className="jumbotron jumbotron-fluid" id="contact">
          <section
            className="section"
            id="reservation"
            style={{ backgroundImage: `url(${table_reservation_image})` }}
          >
            <h6>Reach Out For </h6>
                ...
                <div className="col-lg-6 align-self-center">
                  <div className="left-text-content">
                    ...
                    <p>
                      ...
                      Fusce a eleifend riqsie, namei sollicitudin urna diam, sed
                    ...
                    <div className="row">
                      <div className="col-lg-6">
                        <div className="phone">
                          ...
                          <h4>Phone Numbers</h4>
                          <span>
                            <a href="#">705-843-8927</a>
                            <br />
                            <a href="#">705-846-8927</a>
                          </span>
                        </div>
                      </div>
                      <div className="col-lg-6">
